...
# Check a sample from your dataset to understand its format
...
trainer = SFTTrainer(
    ...
    args=TrainingArguments(
        ...
        num_train_epochs=1,  # Increased from 1 to 3 for better learning
...
# Use the same format with the correct mapping for inference
...
# Print the generated prompt to verify format
print("Generated prompt for inference:")
